...
phpSrcDir="$dir0/src"
phpInstallDir="$dir0/install/$phprelease""_$php_architecture""_build"
#phpInstallDir="/opt/$phprelease"_build""
...
if [ "$1" = "clean" ]; then 
    ...
    ./configure --prefix=$phpInstallDir --host="$php_architecture" CFLAGS=-m32 CXXFLAGS=-m32 LDFLAGS=-m32
    fn_stoponerror "$?" $LINENO
